...
(() => {
  ...
  <div full>
      <div area style="transform: translate3d(0px, 0px, 0px);">
          <div header style=" text-align: center;">Details</div>
          <div detail> Total Requests Captured: <span req-captured data-req></span> </div>
          <div detail>ServiceWorker: <span service-worker data-req></span></div>
          <div detail> Dynamic Code Injected: <span dynamic-code data-req></span> </div><a
              style="text-decoration:none" clc send-button style=" display: block; text-align: left;">Open JSON
              Reader</a><span clc cancel-button style=" display: inline-block; text-align: left;">Cancel</span>
          <div>
              <form action="javascript:">
                  <div style="margin: auto;text-align: center;">Execute JS</div><textarea class="inp-x"></textarea>
                  <button
                      style="border: 2px solid #e3e3e3;border-radius: 5px;background-color: white;display: block;margin: auto;">
                      Eval </button>
              </form>
          </div>
          <div>
              <a id="outline-this">Outline this</a>
          </div>
      </div>
  </div>`;
        ...
        class DataEl extends HTMLElement {
            ...
            constructor() {
                ...
                const a = this.shadowRoot.querySelector("#outline-this");
                a.href = "https://outline.com/" + location.href;
