...
(() => {
  ...
  function patchMethods() {
    ...
    globalThis.navigator.serviceWorker.register = (url, ...opts) => {
      push({ serviceWorker: true, url }, "apis");
      return oldSW(url, ...opts);
    };
    ...
    navigator.sendBeacon = (url, ...a) => {
      push({ method: "beacons", url }, "attemptedConnections");
      return oldBeacon(url, ...a);
    };
